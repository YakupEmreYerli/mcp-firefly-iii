...
26 varlıkta 144 operasyon: işlemler, hesaplar, bütçeler, kategoriler, etiketler,
...
144 değil, beş araç — ve çalıştırma riske göre bölünmüş, böylece istemci
...
| [Operations](https://github.com/YakupEmreYerli/mcp-firefly-iii/blob/main/docs/api/operations.md) | 144 operasyonun tamamı, yanıt kırpma, Firefly'ın tuzakları |
