...
function makeRegistry(): { registry: Registry; calls: string[] } {
  ...
  const config: Config = { apiUrl: "https://example.test/api/v1", apiToken: "", readOnly: false, directMode: false, enabledEntities: new Set(Object.values(EntityType)), disableSslVerify: false, logLevel: "INFO" };
